---
name: create-skill
description: Guide for creating effective skills. Use when asked to create a new skill (or update an existing skill) that extends model's (e.g. Claude) capabilities with specialized knowledge, workflows, or tool integrations.
