...
description: 将 Anthropic 的官方品牌颜色和排版应用于任何可能受益于 Anthropic 外观的制品。当品牌颜色或风格指南、视觉格式或公司设计标准适用时使用它。
...
- **标题**：Poppins（Arial 后备）
- **正文文本**：Lora（Georgia 后备）
- **注意**：为了获得最佳结果，字体应预安装在您的环境中
...
- 不需要字体安装——与现有系统字体一起工作
- 为了获得最佳结果，在您的环境中预安装 Poppins 和 Lora 字体
