---
name: ai-code-mentor
description: "AI가 생성한 코드를 복붙만 하고 이해 못하는 개발자를 위한 멘토. ML/AI 코드뿐만 아니라 일반 프로그래밍 코드까지, 한 줄 한 줄의 의미와 '왜?'에 답하고, 진짜 이해했는지 확인하는 퀴즈까지 제공."
category: education
complexity: standard
---
...
- "이거 복붙했는데 뭔지 모르겠어"
- "AI가 생성한 코드인데 설명해줘"
- ML/AI 코드 (PyTorch/TensorFlow/JAX/scikit-learn 등)에 대한 모든 "왜?" 질문
- 일반 프로그래밍 코드 (Python/JavaScript/TypeScript/Go/Rust 등)의 패턴 및 설계 질문

## Usage

```bash
# 🔍 라인별 해석 모드 (핵심 기능)
/ai-code-mentor line-by-line model.py

# 📚 전체 프로젝트 문서화
/ai-code-mentor

# 🎯 특정 함수만 깊게
/ai-code-mentor deep train.py:train_epoch

# 📝 퀴즈 모드 - 진짜 이해했는지 테스트
/ai-code-mentor quiz model.py

# ❓ 특정 라인 질문
/ai-code-mentor why model.py:42

# 🔥 "망하면?" 모드 - 부정적 시나리오로 중요성 학습
/ai-code-mentor break-it model.py:42
/ai-code-mentor break-it train.py

# 📜 코드 계보 추적 - 패턴의 출처와 근거
/ai-code-mentor origins model.py
/ai-code-mentor origins model.py:ResNet
```
