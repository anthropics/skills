...
**Note**: Links 1 and 4 are "Yes" conditions (green). Links 2 and 6 are "No" conditions (red). All others use default gray. The `FindCard` subgraph groups related nodes with a dashed border.
