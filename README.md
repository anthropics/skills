...
スキルは以下のカテゴリに整理されています：

- **skills/document/** - 文書作成・管理系スキル
- **skills/data-analysis/** - データ分析・可視化系スキル  
- **skills/business/** - ビジネス業務支援系スキル
- **skills/development/** - 開発・技術系スキル
- **professional-skills/** - 職業別特化スキル（税理士、社労士、行政書士など）
