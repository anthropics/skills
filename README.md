...
- **AgenticFlow** - [AgenticFlow Skill for Claude](https://github.com/PixelML/agenticflow-skill) - Enables Claude to design, build, and validate [AgenticFlow](https://agenticflow.ai) automation workflows with 2,500+ service integrations. Works with Claude Code and Claude.ai.
